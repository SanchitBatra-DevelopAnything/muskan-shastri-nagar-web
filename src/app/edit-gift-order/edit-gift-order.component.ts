...
@Component({
  selector: 'app-edit-gift-order',
  templateUrl: './edit-gift-order.component.html',
  styleUrls: ['./edit-gift-order.component.scss']
})
export class EditGiftOrderComponent implements OnInit {
  ...
  getOrderDetails(date:any , key:any)
  {
    ...
    this.apiService.getOrder(date,key).subscribe((order)=>{
      ...
      this.editOrderService.setGiftOrder(order,key);
  ...
  editOrder()
  {
    this.router.navigate(['order/GIFT/edit']);
  }
